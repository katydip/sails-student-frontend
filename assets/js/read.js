 ...
 *
 * x2. Include the following DataTables JavaScript in layout.ejs
 ...
 *
 * x3. Using the DataTables plugin render the table on the page as a DataTable
 *
 * x4. Use the buttons extention to enable the copy, csv, excel, pdf, and print
 *
 * x5. Use the colReorder Plugin to add the ability to reorder columns
 *
 * x6. The table should be able to scroll horizontal
 *
 * 7. Use any other features you find interesting - come back to this. 
 *
